...
public class PasswordEncoder {
    ...
    *转换字节数组为16进制字符串
    ...
    public static void main(String[] args) {
        ...
        boolean passwprdValid2 = encoderSha.isPasswordValid("409cf43cbdc92e1979018b2e2fdc60c7f07673e9", "test");
        System.out.println(passwprdValid2);
    }
}
